...
relay_graph.profile_resource_usage(params, tmp,["data"], device = tvm.cuda(0), target = "cuda", output_file = os.path.join(parent,'gcn.csv'))
op_statistics.calculate_op_distribution("gcn")